 ...
 * Top menu widget
 */
abstract class TopMenu extends \XLite\Module\XC\CanadaPost\View\Menu\Admin\TopMenu implements \XLite\Base\IDecorator
{
    /**
    ...
    protected function defineItems()
    {
        ...
        $list['content'][static::ITEM_CHILDREN]['news_messages'] = array(
            static::ITEM_TITLE  => 'News messages',
