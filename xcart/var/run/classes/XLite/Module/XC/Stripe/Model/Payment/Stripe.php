...
class Stripe extends \XLite\Model\Payment\Base\Online
{
    ...
    {
        return $method->getSetting('accessToken')
        ...
        try {
            ...
            if ($payment->captured) {
                ...
                $transaction->getPaymentTransaction()->getOrder()
                    ->setPaymentStatus(\XLite\Model\Order\Status\Payment::STATUS_PAID);
            }
