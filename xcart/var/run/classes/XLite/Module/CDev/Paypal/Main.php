...
abstract class Main extends \XLite\Module\AModule
{
    ...
    public static function isInContextCheckoutAvailable()
    {
        ...
        if (!isset($result)) {
            ...
            $allowedCurrency = array('USD', 'EUR', 'GBP');
            ...
            $result = in_array($currency, $allowedCurrency)
    ...
    /**
     * Use internal social login
     *
     * @return boolean
     */
    public static function useInternalSocialLogin()
    {
        $module = \XLite\Core\Database::getRepo('XLite\Model\Module')
            ->findOneBy(array('author' => 'CDev', 'name' => 'SocialLogin', 'enabled' => true));
