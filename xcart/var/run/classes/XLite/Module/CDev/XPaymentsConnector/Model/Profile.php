 ...
 * @MappedSuperClass
 */
abstract class Profile extends \XLite\Module\CDev\SocialLogin\Model\Profile implements \XLite\Base\IDecorator
{
     ...
     *
     * @param fixedstring $pendingZeroAuthStatus
     * @return Profile
     */
