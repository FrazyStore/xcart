...
abstract class Order extends \XLite\Module\CDev\Paypal\Model\Order implements \XLite\Base\IDecorator
{
    ...
    /**
     * Set fraud_status_kount
     *
     * @param string $fraudStatusKount
     * @return Order
     */
    public function setFraudStatusKount($fraudStatusKount)
    {
        $this->fraud_status_kount = $fraudStatusKount;
        return $this;
    }

    /**
     * Get fraud_status_kount
     *
     * @return string 
     */
    public function getFraudStatusKount()
    {
        return $this->fraud_status_kount;
    }
}