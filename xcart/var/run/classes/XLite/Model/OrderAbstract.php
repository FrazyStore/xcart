...
abstract class OrderAbstract extends \XLite\Model\Base\SurchargeOwner
{
        ...
        if ($this->statusIsSet) {
            ...
            if ($changed) {
                if (!$this->isNotificationSent && $this->isNotificationsAllowed()) {
                    \XLite\Core\Mailer::getInstance()->sendChangedOrder($this, $this->isIgnoreCustomerNotifications());
                }
    ...
    protected function processProcess()
    {
        if ($this->isNotificationsAllowed()) {
            \XLite\Core\Mailer::getInstance()->sendProcessOrder($this, $this->isIgnoreCustomerNotifications());
        }
    ...
    {
        if ($this->isNotificationsAllowed()) {
            \XLite\Core\Mailer::getInstance()->sendFailedOrder($this, $this->isIgnoreCustomerNotifications());
        }
    ...
    {
        if ($this->isNotificationsAllowed()) {
            \XLite\Core\Mailer::getInstance()->sendCanceledOrder($this, $this->isIgnoreCustomerNotifications());
        }
