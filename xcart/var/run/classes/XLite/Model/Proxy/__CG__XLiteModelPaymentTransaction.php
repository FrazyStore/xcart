...
class Transaction extends \XLite\Model\Payment\Transaction implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setCallCheckoutSuccessNecessary($isNecessary);
    }

    public function isCallCheckoutSuccessNecessary()
    {
        $this->__load();
        return parent::isCallCheckoutSuccessNecessary();
    }
    ...
    {
        return array('__isInitialized__', 'transaction_id', 'publicTxnId', 'method_name', 'method_local_name', 'status', 'value', 'note', 'type', 'public_id', 'xpc_data', 'order', 'payment_method', 'data', 'backend_transactions');
    }
