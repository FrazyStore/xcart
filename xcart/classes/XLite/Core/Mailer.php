...
class Mailer extends \XLite\Base\Singleton
{
    ...
    const TYPE_LOW_LIMIT_WARNING        = 'ordersDep';
    ...
    public static function sendFailedAdminLoginNotification($postedLogin)
    {
        ...
        if ($postedLogin && $postedLogin != static::getSiteAdministratorMail()) {
            static::compose(
                static::TYPE_FAILED_ADMIN_LOGIN,
                static::getSiteAdministratorMail(),
                $postedLogin,
     ...
     * @return void
     */
    public static function sendProcessOrder(\XLite\Model\Order $order, $ignoreCustomerNotification = false)
    {
        static::register(
            array('order' => $order,)
        );
     ...
     * @return void
     */
    public static function sendChangedOrder(\XLite\Model\Order $order, $ignoreCustomerNotification = false)
    {
        static::register(
            array('order' => $order,)
        );
     ...
     * @return void
     */
    public static function sendAdvancedChangedOrderCustomer(\XLite\Model\Order $order)
    {
        static::register(
            array('order' => $order,)
        );
     ...
     * @return void
     */
    public static function sendFailedOrder(\XLite\Model\Order $order, $ignoreCustomerNotification = false)
    {
        static::register(
            array('order' => $order,)
        );
     ...
     * @return void
     */
    public static function sendCanceledOrder(\XLite\Model\Order $order, $ignoreCustomerNotification = false)
    {
        static::register(
            array('order' => $order,)
        );
     ...
     * @return void
     */
    public static function sendLowLimitWarningNotification($data)
    {
     ...
     * @param string  $mailInterface Interface to compile mail templates (skin name: customer, admin or mail) OPTIONAL
