...
abstract class Checkout extends \XLite\View\Checkout implements \XLite\Base\IDecorator
{
    ...
    protected function getSigninAnonymousTitle()
    {
        return (
            ...
            : static::t('Register with PayPal or go to checkout as a New customer', array(
                'paypal' => $this->getWidget(array(), '\XLite\Module\CDev\Paypal\View\Login\Icon')->getContent()
            ));
    }
}
