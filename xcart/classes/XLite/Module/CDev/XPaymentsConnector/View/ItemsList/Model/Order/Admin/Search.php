...
class Search extends \XLite\View\ItemsList\Model\Order\Admin\Search implements \XLite\Base\IDecorator
{
    ...
    protected function defineColumns()
    {
		...
		$columns['fraud_status_kount'] = array(
            static::COLUMN_NAME     => '',
    ...
    protected function getColumnClass(array $column, \XLite\Model\AEntity $entity = null)
    {
        ...
        if ('fraud_status_kount' == $column[static::COLUMN_CODE]) {
            $result = 'fraud-status-' . $entity->getFraudStatusKount();
        }
     ...
     * @return string
     */
    protected function getFraudInfoKountLink(\XLite\Model\AEntity $entity)
    {
        ...
        $result .= '#' . $entity->getFraudInfoKountAnchor();
     ...
     * @return mixed
     */
    protected function getFraudInfoKountTitle(\XLite\Model\AEntity $entity)
    {
        return $entity->getFraudStatusKount();
    }
}
