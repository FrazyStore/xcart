...
class Settings extends \XLite\View\Model\ModuleSettings
{
    ...
    protected function getFormButtons()
    {
        ...
        if (\XLite\Module\CDev\XPaymentsConnector\Core\Settings::SECTION_CONNECTION == $section) {
        ...
        } elseif (\XLite\Module\CDev\XPaymentsConnector\Core\Settings::SECTION_PAYMENT_METHODS == $section) {
            $result = array();
        }
