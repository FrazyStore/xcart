...
class Inventory extends \XLite\Model\Inventory implements \XLite\Base\IDecorator
{
    ...
    {
        if (\XLite::getController() instanceOf \XLite\Controller\ACustomer) {
        ...
        return parent::isOutOfStock() ?: $this->getAvailableAmount() < $this->getProduct()->getMinQuantity($membership);
    }
}
