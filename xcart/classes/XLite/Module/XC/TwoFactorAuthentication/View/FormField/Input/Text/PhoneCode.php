...
class PhoneCode extends \XLite\View\FormField\Input\Text\Integer
{
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams[static::PARAM_MOUSE_WHEEL_CTRL] = new \XLite\Model\WidgetParam\Bool('Mouse wheel control', false);
        $this->widgetParams[static::PARAM_MOUSE_WHEEL_ICON] = new \XLite\Model\WidgetParam\Bool('User mouse wheel icon', false);
    }
