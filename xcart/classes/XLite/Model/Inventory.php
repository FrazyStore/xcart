...
class Inventory extends \XLite\Model\AEntity
{
    ...
    {
        return $this->getEnabled() && $this->getLowLimitEnabled() && $this->getPublicAmount() <= $this->getLowLimitAmount();
    }
    ...
    {
        \XLite\Core\Mailer::sendLowLimitWarningNotification($this->prepareDataForNotification());
    }
