      ...
      <div class="title">
        ...
        <li class="order-spec-wrapper">{*order number, date, total, num items*}
          <ul class="order-spec">
            ...
            <li class="order-total"><span class="order-spec-label total-label">{t(#Total#)}:</span><span class="order-spec-value total-value">{formatPrice(order.getTotal(),order.getCurrency(),1)}</span></li>
