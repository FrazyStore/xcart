...
<div class="{getDialogCSSClasses()}">
  ...
  <div class="sales-tax-options">
    <div class="sales-tax-options-block">
      <widget class="\XLite\View\FormField\Input\Checkbox" fieldName="use_memberships" isChecked="{config.CDev.SalesTax.use_memberships}" label="{t(#Use user memberships in the tax calculation#)}" />
    </div>
    <div class="sales-tax-options-block">
  ...
  <div IF="!isShippingRatesDisplayed()" id="items-list-switcher">
    <span>{t(#Click here to specify separate rates only on shipping cost#)}</span>
