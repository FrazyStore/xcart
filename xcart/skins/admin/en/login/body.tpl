    ...
    <form id="login_form" action="{buildURL(#login#)}" method="post" name="login_form">
      ...
      <table>
        <tbody class="fields">
          <tr>
            <th>{t(#Email#)}:</th>
            <td><input type="text" class="form-control" name="login" value="{login:r}" size="32" maxlength="128" autocomplete="off" /></td>
          </tr>
          <tr>
            <th>{t(#Password#)}:</th>
            <td><input type="password" class="form-control" name="password" value="{password:r}" size="32" maxlength="128" autocomplete="off" /></td>
          </tr>
        </tbody>
