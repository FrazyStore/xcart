...
<tr IF="isCleanURLEnabled()">
  <td class="setting-name">{t(#Clean URLs are enabled#)}</td>
  <td>&nbsp;</td>
</tr>

<tr IF="!isCleanURLEnabled()" class="clean-urls-disabled">
  <td class="setting-name">{t(#Clean URLs are disabled#)}:</td>
  <td IF="canEnableCleanURL()"><widget class="\XLite\View\Button\Link" location="{buildURL(#settings#,#enable_clean_url#,_ARRAY_(#page#^#Environment#))}" label="{t(#Enable clean URLs#)}" /></td>
  <td IF="!canEnableCleanURL()">{t(#Clean URLs functionality may not be enabled. More info#,_ARRAY_(#article_url#^getCleanURLArticleURL())):h}</td>
</tr>
...
<widget IF="libcurl" template="settings/base.tpl" />
